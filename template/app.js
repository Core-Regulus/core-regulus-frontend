...
scene.fog = new THREE.FogExp2(0xffffff00, 0.01);

const camera = new THREE.PerspectiveCamera(75, 1, 0.1, 1000); // aspect будет обновлён позже
...
renderer.setClearColor(0x060A33, 0);
...
controls.maxDistance = 15; // Фиксируем расстояние камеры
...
const sphereColors = [
new THREE.Color('#0B0A13'), // почти чернильная тьма
new THREE.Color('#13193E'), // глубокий сине-индиго
new THREE.Color('#3D0066'), // фиолетовый бархат
new THREE.Color('#7A9DCB'), // небесный холодный акцент
new THREE.Color('#C0C0C0'), // серебристый свет для ядра
new THREE.Color('#FFFFFF')  // точечные вспышки
];
